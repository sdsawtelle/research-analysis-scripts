...
def plot_trace_fit_combo_FINALEM(path, deltarj):
    ...
    with open("fit_results_df_deltarj_%i_FINALEM.pickle" % (deltarj,), "rb") as myfile:
        fitdf = pickle.load(myfile)

    with open("fit_results_dict_deltarj_%i_FINALEM.pickle" % (deltarj,), "rb") as myfile:
        fitdict = pickle.load(myfile)
...
def prep_device_FINALEM(port, path, deltarj=20):
    ...
    if os.path.isfile("prepped_traces_dict_FINALEM.pickle"):
        with open("prepped_traces_dict_FINALEM.pickle", "rb") as myfile:
    ...
    for tr in traces:
        if "final" in tr[0]:
            ...
            df = choose_false_ramps(df, df_other, type=this_tr, deltarj=deltarj + 125)
            ...
            with open("prepped_traces_dict_FINALEM.pickle", "wb") as myfile:  # Pickle after every dev, b/c sometimes stuff crashes
...
def optimize_pc_FINALEM(path, deltarj, rsqrd_cutoff, varseries=False):
    ...
    with open("pc_analysis_deltarj_%i_FINALEM.pickle" % (deltarj,), "wb") as myfile:
        pickle.dump(df, myfile)
...
["C:/Users/Sonya/Documents/My Box Files/molT Project/170124_SDS20_Chip_4-11/50x400", "4-11", "50x400"],
...
["C:/Users/Sonya/Documents/My Box Files/molT Project/170206_SDS20_Chip_10-8/30x60", "10-8", "30x60"],
["C:/Users/Sonya/Documents/My Box Files/molT Project/170206_SDS20_Chip_10-8/50x60", "10-8", "50x60"],
["C:/Users/Sonya/Documents/My Box Files/molT Project/170206_SDS20_Chip_10-8/50x400", "10-8", "50x400"],
["C:/Users/Sonya/Documents/My Box Files/molT Project/170206_SDS20_Chip_10-8/30x400", "10-8", "30x400"],
["C:/Users/Sonya/Documents/My Box Files/molT Project/170207_SDS20_Chip_11-8/30x60", "11-8", "30x60"],
["C:/Users/Sonya/Documents/My Box Files/molT Project/170207_SDS20_Chip_11-8/50x60", "11-8", "50x60"],
["C:/Users/Sonya/Documents/My Box Files/molT Project/170207_SDS20_Chip_11-8/50x400", "11-8", "50x400"],
["C:/Users/Sonya/Documents/My Box Files/molT Project/170207_SDS20_Chip_11-8/30x400", "11-8", "30x400"],
["C:/Users/Sonya/Documents/My Box Files/molT Project/170212_SDS20_Chip_13-8/30x60", "13-8", "30x60"],
["C:/Users/Sonya/Documents/My Box Files/molT Project/170212_SDS20_Chip_13-8/50x60", "13-8", "50x60"],
["C:/Users/Sonya/Documents/My Box Files/molT Project/170212_SDS20_Chip_13-8/50x400", "13-8", "50x400"],
["C:/Users/Sonya/Documents/My Box Files/molT Project/170212_SDS20_Chip_13-8/30x400", "13-8", "30x400"],
["C:/Users/Sonya/Documents/My Box Files/molT Project/170213_SDS20_Chip_13-9/30x60", "13-9", "30x60"],
["C:/Users/Sonya/Documents/My Box Files/molT Project/170213_SDS20_Chip_13-9/50x60", "13-9", "50x60"],
["C:/Users/Sonya/Documents/My Box Files/molT Project/170213_SDS20_Chip_13-9/50x400", "13-9", "50x400"],
["C:/Users/Sonya/Documents/My Box Files/molT Project/170213_SDS20_Chip_13-9/30x400", "13-9", "30x400"],
]


datafiles = [
["C:/Users/Sonya/Documents/My Box Files/molT Project/170223_SDS20_Chip_3-10/30x60", "3-10", "30x60"],
["C:/Users/Sonya/Documents/My Box Files/molT Project/170223_SDS20_Chip_3-10/50x60", "3-10", "50x60"],
["C:/Users/Sonya/Documents/My Box Files/molT Project/170223_SDS20_Chip_3-10/50x400", "3-10", "50x400"],
["C:/Users/Sonya/Documents/My Box Files/molT Project/170223_SDS20_Chip_3-10/30x400", "3-10", "30x400"],
]
...
prep_device_FINALEM("FT2_1413", path, deltarj=20)  # Revise prep for any device as needed


#####################################################################
####### EFFECT OF DELTARJ AND R^2 ##########
#####################################################################
deltarjs = np.arange(50, 120, 20)
...
plt.savefig("OptimalParams_Scatter_FINALEM.png")
plt.close("all")
...
for dataf in datafiles:
    ...
    for f in os.listdir(path):
        if ("fit_results" in f or "pc_analysis" in f or "Trace_Fit_Combo" in f) and ("FINALEM" in f):
            os.remove(f)
    ...
    with open("pc_analysis_deltarj_%i_FINALEM.pickle" % (deltarj,), "rb") as myfile:
    ...
    plt.savefig("Fitted_Params_FINALEM.png")
    plt.close("all")
...
df_all.loc[(df_all["chip"] == "12-9") & (df_all["ports"] == "FT1_1213"), "pc_conforms"] = 0
df_all.loc[(df_all["chip"] == "12-9") & (df_all["ports"] == "FT2_2021"), "pc_conforms"] = 0
df_all.loc[(df_all["chip"] == "11-8") & (df_all["ports"] == "FT3_1011"), "pc_conforms"] = 0
df_all.loc[(df_all["chip"] == "13-8") & (df_all["ports"] == "FT2_0203"), "pc_conforms"] = 0
df_all.loc[(df_all["chip"] == "13-8") & (df_all["ports"] == "FT1_2826"), "pc_conforms"] = 0
df_all.loc[(df_all["chip"] == "13-9") & (df_all["ports"] == "FT1_0708"), "pc_conforms"] = 0
...
fig, ax = snp.newfig()
snp.labs("Temperature (K)", "Fitted $P_c$ (mW)", "$P_c$ vs. $T$ All Geometries")
for grp in mus.index.levels[0]:
    ...
    ax.plot(temps, means, linestyle="None", markersize=7, label=grp)
pylab.legend(loc="best")
ax.set_xlim([70, 250])
plt.savefig("Pc_FinalEM_Aggregated.png")
